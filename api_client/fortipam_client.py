...
class FortiPAMApiClient(client.ApiClient):
    ...
    def parse_headers_cookie(self, headers):
        cookies = ''
    ...
    def _login(self, conn=None, headers=None):
        ...
        if ret:
            ...
            cookies += self.parse_headers_cookie(res_headers)
        redirect_message = self.render(getattr(self._template, 'REDIRECT'))
        g = eventlet_request.EventletApiRequest(
        ...
        cookies += self.parse_headers_cookie(redirect_headers)
